# yolov8n-pose.onnx 集成参考

本文只记录 Android 端集成 `yolov8n-pose.onnx` 时主要参考的文档地址。
...
- Ultralytics PosePredictor 后处理源码文档  
  https://docs.ultralytics.com/reference/models/yolo/pose/predict/
...
- `YoloOutputParser.parsePose(...)`
- `CameraV2OnnxAnalyzer.runPoseDetector(...)`
